...
--
-- Host: mysql-db.apps.cactuspdv.com    Database: cactuspdv
-- ------------------------------------------------------
...
CREATE TABLE `inventory_items` (
  ...
  `min_quantity_threshold` decimal(10,3) NOT NULL,
...
CREATE TABLE `inventory_logs` (
  ...
  `previous_quantity` decimal(10,3) DEFAULT NULL,
...
-- Dump completed on 2025-06-12 22:09:33
